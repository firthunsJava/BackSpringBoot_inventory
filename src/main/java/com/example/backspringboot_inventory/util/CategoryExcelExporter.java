package com.example.backspringboot_inventory.util;
...
public class CategoryExcelExporter {
    ...
    /**
     * Va a escribir la cabecera de nuestro archivo excel
     */
    private void writeHeaderLine() {
        ...
        XSSFFont font = workbook.createFont(); // crea la fuente de nuestro excel
        font.setBold(true);
